...
namespace CommonLib.Encrypts
{
    ...
    public class EncryptHelper
    {
        ...
        /// <summary>
        /// HMACSHA1算法加密，然后进行base64编码
        /// </summary>
        /// <param name="value">签名参数字符串</param>
        /// <param name="hmacKey">密钥参数</param>
        /// <returns>返回一个签名值(即哈希值)</returns>
        public static string HMACMD5(string value, string hmacKey = null)
        {
            ...
            return Base64Encode(BitConverter.ToString(output).Replace("-", ""));
        }
        #endregion
